...
public class ProdutoResource {
    ...
    public ResponseEntity<Page<ProdutoDTO>> findPage(
        ...
        Page<Produto> list = sProduto.search(nomeDecoded, ids, page, linesPerPage, orderBy, direction);
        Page<ProdutoDTO> listDto = list.map(oProdutoDTO -> new ProdutoDTO(oProdutoDTO));
